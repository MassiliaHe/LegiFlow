...
def build_extractor_system_prompt(codes: List[str], prompts: dict = prompts) -> str:
    description = prompts["prompts"]["extractor"]["description"]
...
def build_summary_system_prompt(results: str, prompts: dict = prompts) -> str:
    description = prompts["prompts"]["summary"]["description"]
    return f"""{description}
